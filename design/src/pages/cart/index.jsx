...
const Cart = () => {
    ...
    return (
      <div className="pt-[80px] font-poppins">                <h1 className="text-center text-[54px] leading-[58px]  font-poppins font-medium  ">Cart</h1>

        <div className="lg:px-[160px] my-[80px] p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
                ...
                {carts.map((item) => (
                    <div key={item.id} className="border-b flex flex-col md:flex-row items-center py-4">
                        ...
                        <div className="w-full md:w-1/6 text-center mt-2 md:mt-0">${item.discountprice.toFixed(2)}</div>
                        <div className="w-full md:w-1/6 text-center mt-2 md:mt-0">${(item.discountprice * item.quantity).toFixed(2)}</div>
                    </div>
                ))}
            ...
            <div className="border p-6">
                ...
                <div className="mb-4">
                    <div className="flex justify-between py-2">
                        <label>
                            <input type="radio" name="shipping" value="free" defaultChecked onChange={handleShippingChange} /> Free shipping
                        </label>
                        <span>$0.00</span>
                    </div>
                    <div className="flex justify-between py-2">
                        <label>
                            <input type="radio" name="shipping" value="express" onChange={handleShippingChange} /> Express shipping
                        </label>
                        <span>+$15.00</span>
                    </div>
                    <div className="flex justify-between py-2">
                        <label>
                            <input type="radio" name="shipping" value="pickup" onChange={handleShippingChange} /> Pick Up
                        </label>
                        <span>%21.00</span>
                    </div>
                </div>
