...
const Product = () => {
  return (
    ...
    <div className=' w-full h-[349px] overflow-hidden relative'>
< Test className="w-full h-full object-cover"/>
  <div className='absolute top-[16px] left-[16px] flex flex-col justify-start items-start gap-[8px]'>
...
<div className='text-base font-inter font-semibold capitalize leading-[26px]'>
table lamp

</div>
<div className='flex justify-start gap-[12px] text-base font-inter font-semibold capitalize leading-[26px]'>
<div>
  $19.00
  </div>
